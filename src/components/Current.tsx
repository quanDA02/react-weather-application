    ...
    <Card title="Current Weather">
      <div className="justify-items-center">
        ...
        <div className="flex flex-row gap-8">
          <WeatherCondition title="Feels like" number={current.feelslike_c} unit="&deg;C"/>
          <WeatherCondition title="Humidity" number={current.humidity} unit="%"/>
          <WeatherCondition title="Wind" number={current.wind_kph} unit="km/h"/>
        </div>
      </div>
    </Card>
  )
